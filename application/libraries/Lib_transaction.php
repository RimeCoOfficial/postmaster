...
class Lib_transaction
{
  ...
  function modify($transaction_id, $subject, $reply_to_name, $reply_to_email, $message_html, $category_id)
  {
    ...
    $this->CI->model_transaction->update($transaction_id, $subject, $reply_to_name, $reply_to_email, $message_html, $category_id);
    return TRUE;
  }
